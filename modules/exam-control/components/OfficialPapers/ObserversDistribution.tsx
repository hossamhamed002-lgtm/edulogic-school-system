...
const ObserversDistribution: React.FC<Props> = ({ schoolInfo, selectedGrade, selectedTerm }) => {
  ...
  return (
    <div className="space-y-12 bg-gray-50 p-4 no-print-bg" dir="rtl">
      ...
      {schedule.map((exam, examIdx) => (
        <div key={exam.id} id="print-paper" className="p-[10mm] bg-white text-black font-sans flex flex-col print-container border-[1px] border-gray-300 shadow-lg break-after-page">
