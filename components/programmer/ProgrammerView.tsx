...
import { Cpu, Settings, ChevronLeft, School, Database, Trash2, Shield, HeartPulse, Clock, BellRing, ActivitySquare } from 'lucide-react';
...
type ProgrammerSubScreen = 'hub' | 'schools' | 'backup' | 'purge' | 'security' | 'health' | 'audit' | 'alerts' | 'healthdash';
