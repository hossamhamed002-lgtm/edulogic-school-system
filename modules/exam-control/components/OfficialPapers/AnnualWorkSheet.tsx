...
const AnnualWorkSheet: React.FC<Props> = ({ schoolInfo, selectedGrade, selectedTerm, selectedClass }) => {
  ...
  return (
    <div id="print-paper" className="p-[5mm] bg-white text-black font-sans flex flex-col w-[210mm] min-h-[297mm] mx-auto" dir="rtl">
      <style dangerouslySetInnerHTML={{ __html: `
        @media print {
          @page { size: A4 portrait !important; margin: 0 !important; }
          #print-paper { width: 100% !important; height: auto !important; padding: 10mm !important; border: none !important; }
